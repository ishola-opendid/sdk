...
// Core API
export { default as OpenDID, type OpenDIDConfig } from './core.js';
...
export type {
  DIDClaimsRegistryContract
} from './infrastructure/contracts/DIDClaimsRegistryContract.js';

// Legacy exports for backward compatibility
export { default as CoreAPI } from './core.js';
